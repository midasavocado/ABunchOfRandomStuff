#!/bin/bash
# LODESTAR — double-click to render the film on this Mac's GPU (full film at 3840x2160 — slowest, sharpest).
cd "$(dirname "$0")" || exit 1
clear
echo
echo "   L  O  D  E  S  T  A  R"
echo "   the film renderer  —  preset: 4k"
echo
...
if uv run --quiet --python 3.12 render.py --preset 4k; then
  echo
  echo "   Done! Opening LODESTAR_4k.mp4 ..."
  open "LODESTAR_4k.mp4"
else
  echo
